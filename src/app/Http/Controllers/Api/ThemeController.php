...
class ThemeController extends Controller
{
    ...
    {
        $themes = Theme::visibleTo(auth()->id())->withCount('stocks')->orderByDesc('stocks_count')->orderBy('name')->get();
    ...
    {
        abort_unless($theme->isSystem() || $theme->user_id === auth()->id(), 403);
    ...
    {
        $theme = Theme::create($request->validated() + ['user_id' => auth()->id()]);
    ...
    {
        abort_unless($theme->user_id === auth()->id(), 403);
